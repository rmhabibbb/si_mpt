<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="<?= base_url(); ?>pemilik/user_form" class="btn btn-primary mb-5"><i class="fas fa-user-plus mr-5"></i>Tambah</a>
                        ...
                        <table class="table table-hover table-bordered table-sm" id="example" style="width:100%">
                            ...
                            <tbody>
                                <?php foreach ($users as $key => $value) : ?>
                                    <tr id="<?= $value->username; ?>">
                                        <td><?= $value->username; ?></td>
                                        <td><?= $value->nama_user; ?></td>
                                        <td><?= $value->no_hp; ?></td>
                                        <td>
                                            <?= ($value->role == 1) ? 'Admin' : 'Kasir'; ?>
                                        </td>
                                        <td>
    ...
    $('.hapus-user').on('click', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    'url': '<?= base_url('pemilik/user_delete') ?>',
                    'type': 'POST',
                    'data': {
                        id: id
                    },
