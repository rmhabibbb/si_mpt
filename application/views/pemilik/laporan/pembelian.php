...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-md-12 bg-white p-4 rounded shadow">
            <?php echo form_open_multipart('pemilik/download_laporan_pembelian'); ?>
            <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        var dataAplikasi = $('#data-table-transaksi').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url(); ?>Pemilik/filterLaporanSupply",
                "type": "POST",
        ...
        $('#filter').click(function() {
            dataAplikasi.ajax.url("<?= base_url(); ?>Pemilik/filterLaporanSupply?start_date=" + start_date + "&end_date=" + end_date).load();
        })
    });
