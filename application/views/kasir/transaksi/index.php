...
<?php $this->load->view('kasir/transaksi/modal/index_modal') ?>
<?php $this->load->view('kasir/transaksi/modal/checkout_modal') ?>
...
<script>
    ...
    var dataAplikasi = $('#data-table-barang').DataTable({
        ...
        "ajax": {
            "url": "<?= base_url(); ?>Kasir/getDataBarangTransaksi",
            "type": "POST",
            "data": {
                x: x
            },
    ...
    $(document).ready(function() {
        ...
        $('#id_kategori').on('change', function() {
            ...
            dataAplikasi.ajax.url("<?= base_url(); ?>Kasir/getDataBarangTransaksi?x=" + x).load();
        })
        ...
        $(document).on('click', '#view-modal_detail_barang', function(e) {
            ...
            $.ajax({
                'url': '<?php echo base_url(); ?>Kasir/get_barang_by_id',
                'type': 'POST',
                'data': {
                    id: id
                },
        ...
        $('#btnSendtoCart').on('click', function(e) {
            ...
            var qty = $('#qty').val();
            $.ajax({
                'url': '<?php echo base_url() ?>Kasir/send_to_cart',
                'type': 'POST',
                'data': {
                    id: id,
                    qty: qty
        ...
        $('#batal_detail').on('click', function(e) {
            ...
            var id = $(this).attr('data-id');
            $.ajax({
                'url': '<?php echo base_url() ?>Kasir/batal_detail',
                'type': 'POST',
                'data': {
                    id: id
                },
        ...
        $('#tambah_detail').on('click', function(e) {
            ...
            var id = $(this).attr('data-id');
            $.ajax({
                'url': '<?php echo base_url() ?>Kasir/tambah_detail',
                'type': 'POST',
                'data': {
                    id: id
                },
        ...
        $('#btnSendCheckout').on('click', function(e) {
            ...
            $.ajax({
                'url': '<?php echo base_url() ?>Kasir/send_checkout',
                'type': 'POST',
                'data': data,
                'dataType': 'json',
                beforeSend: function() {
    ...
    function kurang_detail(idx) {
        $.ajax({
            'url': '<?php echo base_url() ?>Kasir/kurang_detail',
            'type': 'POST',
            'data': {
                id: idx
            },
