...
<?php $this->load->view('kasir/transaksi/modal/retur_modal') ?>
<!-- Sweet Alert -->
...
<script>
    $(document).ready(function() {
        ...
        var dataAplikasi = $('#data-table-transaksi').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url(); ?>Kasir/getDetailTransaksi",
                "type": "POST",
                "data": {
                    kd: kd_trans
                },
        ...
        $('#btnReturn').on('click', function(e) {
            ...
            if (qty_return == 0) {
                ...
                $.ajax({
                    'url': '<?php echo base_url() ?>Kasir/send_return',
                    'type': 'POST',
                    'data': {
                        id: id,
                    ...
                    success: function(respon) {
                        if (respon.status == 'success') {
                            ...
                            dataAplikasi.ajax.url("<?= base_url(); ?>Kasir/getDetailTransaksi").load();
                            Swal.fire({
                                'title': respon
                                    .status,
                                'icon': respon
