        ...
        <div class="col-12 bg-white p-4 rounded shadow">
            ...
            <form id="formAddBarang" enctype="multipart/form-data" action="<?= base_url() ?>admin/barang_store" method="post">
                ...
                <div class="row mb-4 mb-4">
                    ...
                    <div class="col-sm-9">
                        <div class="preview">
                            <img id="file-ip-1-preview" src="<?= base_url('assets/default.png') ?>">
                            <input type="file" class="form-control mt-1" name="foto" id="file-ip-1" accept="image/*" onchange="showPreview(event);">
