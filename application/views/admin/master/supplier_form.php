        ...
        <div class="col-12 bg-white p-4 rounded shadow">
            ...
            <form id="formSupplier">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                        <button type="button" id="btnAddSupplier" class="btn btn-primary">Simpan</button>
...
<script>
    $(document).ready(function() {
        $('#btnAddSupplier').on('click', function(e) {
            ...
            $.ajax({
                'url': '<?php echo base_url() ?>admin/supplier_store',
                'type': 'POST',
                'data': data,
                'dataType': 'json',
                success: function(respon) {
                    if (respon.status ==
                        'success') {
                        window.location.replace("<?= base_url('admin/supplier') ?>");
