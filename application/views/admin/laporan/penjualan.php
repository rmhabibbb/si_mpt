...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-md-12 bg-white p-4 rounded shadow">
            <?php echo form_open_multipart('admin/pdf_penjualan'); ?>
            <div class="row">
                ...
                <div class="col-md-5 mt-2">
                    ...
                    <!-- <button type="submit" name="excel" class="btn btn-success" id="pdf"><span class="far fa-file-excel me-2"></span>Export</button> -->
...
<script>
    $(document).ready(function() {
        ...
        var dataAplikasi = $('#data-table-transaksi').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url(); ?>Admin/filterLaporan",
                "type": "POST",
        ...
        $('#filter').click(function() {
            dataAplikasi.ajax.url("<?= base_url(); ?>Admin/filterLaporan?start_date=" + start_date + "&end_date=" + end_date).load();
        })
    });
