        ...
        <div class="modal-content">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" type="number" min="1" value="1" id="qty">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" type="text" min="0" value="0" id="harga_supply">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer d-flex justify-content-between">
                <div style=" font-size:120%">
                    <b>Sub Total : Rp. <span id="sub_total_supply"></span> </b>
                </div>
