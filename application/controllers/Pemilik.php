...
class Pemilik extends MY_Controller
{
    ...
    public function pdf_penjualan()
    {
        ...
        $mpdf = new \Mpdf\Mpdf();
        $html = $this->load->view('pemilik/laporan/download_penjualan', $this->data, true);
        $mpdf->WriteHTML($html);
    ...
    public function pdf_pembelian()
    {
        ...
        $mpdf = new \Mpdf\Mpdf();
        $html = $this->load->view('pemilik/laporan/download_pembelian', $this->data, true);
        $mpdf->WriteHTML($html);
        // $mpdf->Output(); // opens in browser
        $mpdf->Output($filename . '.pdf', 'D'); // it downloads the file into the user system, with give name
    }
    ...
    public function pdf_stok()
    {
        ...
        $mpdf = new \Mpdf\Mpdf();
        $html = $this->load->view('pemilik/laporan/download_stok', $this->data, true);
        $mpdf->WriteHTML($html);
        // $mpdf->Output(); // opens in browser
        $mpdf->Output($filename . '.pdf', 'D'); // it downloads the file into the user system, with give name
    }
